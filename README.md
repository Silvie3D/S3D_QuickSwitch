...
## Installation
1. Visit the Blender Extensions platform to install the addon: [Waiting for approval]. Or, Download the "S3D_QuickSwitch.zip" froom: [Releases](https://github.com/Silvie3D/S3D_QuickSwitch/releases)
